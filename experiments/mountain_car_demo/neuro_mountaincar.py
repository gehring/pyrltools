...
def run_exp(p):
    alpha, alpha_mu, eta, num_episodes, max_length, layers = [p[k] for k in ['alpha', 'alpha_mu', 'eta', 'num_episodes', 'max_length', 'layers']]
...
filename = '/media/cgehri/data/experiment_data/mountaincar/test-200-More'
